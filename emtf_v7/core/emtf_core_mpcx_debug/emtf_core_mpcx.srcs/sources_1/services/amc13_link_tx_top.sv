...
(
    ...
    input DAQ_0_mmcm_clk, // BUFGed version of mgttx.txoutclk
    ...
    input gt0_txresetdone_i, // simulated by software
    input reset,
    input cnt_reset
);
...
//    IBUFG k_rx_bufg (.I(k_rx_clk), .O(k_rx_clk_b));
    ...
    assign mgttx[0].txcharisk = txcharisk;
    assign mgttx[0].txdata = txdata;
    assign usr_clk = DAQ_0_mmcm_clk;
    ...
    // Adrian's code below was initially buggy, reworked to provide delay
