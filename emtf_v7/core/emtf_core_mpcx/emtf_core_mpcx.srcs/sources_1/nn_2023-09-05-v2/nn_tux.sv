...
(
    ...
    begin
        ...
        pt_r[mux_phase_out[mux_phase]] <= PT;
    ...
    emtfnn_wrapper dxy_nn (
            ...
            // New inputs
            .sector_V(sector),
            .ch_id_0_V(bt_ci[mux_phase][0]),
            .ch_id_1_V(bt_ci[mux_phase][1]),
            .ch_id_2_V(bt_ci[mux_phase][2]),
            .ch_id_3_V(bt_ci[mux_phase][3]),
            .ch_id_4_V(bt_ci[mux_phase][4]),
            .st1a_segs_valid_V(bt_vi[mux_phase][0]),
            .st1b_segs_valid_V(bt_vi[mux_phase][1]),
