//`ifndef PH_INIT_HARD_SV
//`define PH_INIT_HARD_SV
	...
	// so far just taken the coordinates from corresponding CSC chambers
   	integer ge11_ph_init_hard [7][2]; // [schamber][layer]
   	initial
	begin
		ge11_ph_init_hard[0] = '{ 38,  38};
		ge11_ph_init_hard[1] = '{ 57,  57};
		ge11_ph_init_hard[2] = '{ 76,  76};
		ge11_ph_init_hard[3] = '{ 95,  95};
		ge11_ph_init_hard[4] = '{113, 113};
		ge11_ph_init_hard[5] = '{132, 132};
		ge11_ph_init_hard[6] = '{151, 151};
	end
//`endif
