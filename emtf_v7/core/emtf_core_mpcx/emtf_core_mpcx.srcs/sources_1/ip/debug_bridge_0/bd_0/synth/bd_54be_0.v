...
//--------------------------------------------------------------------------------
//Command: generate_target bd_54be_0.bd
//Design : bd_54be_0
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_54be_0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_54be_0,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "debug_bridge_0.hwdef" *) 
module bd_54be_0
   (jtag_tck,
    jtag_tdi,
    jtag_tdo,
  ...
  bd_54be_0_bs_switch_0_0 bs_switch_0
