...
-- Date        : Tue Jun 30 10:48:38 2020
-- Host        : endcap-tf1.phys.ufl.edu running 64-bit CentOS Linux release 7.8.2003 (Core)
-- Command     : write_vhdl -force -mode funcsim
--               /home/madorsky/cernbox/projects/vivado/emtf_v7/core/emtf_core_mpcx/emtf_core_mpcx.srcs/sources_1/ip/debug_bridge_1/bd_0/ip/ip_1/bd_947f_0_lut_buffer_0_sim_netlist.vhdl
-- Design      : bd_947f_0_lut_buffer_0
...
entity bd_947f_0_lut_buffer_0_lut_buffer_v2_0_0_lut_buffer is
  port (
    tms_i : in STD_LOGIC;
    tdi_i : in STD_LOGIC;
    tck_i : in STD_LOGIC;
  ...
  attribute C_EN_BSCANID_VEC of bd_947f_0_lut_buffer_0_lut_buffer_v2_0_0_lut_buffer : entity is 0;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of bd_947f_0_lut_buffer_0_lut_buffer_v2_0_0_lut_buffer : entity is "lut_buffer_v2_0_0_lut_buffer";
  attribute dont_touch : string;
  attribute dont_touch of bd_947f_0_lut_buffer_0_lut_buffer_v2_0_0_lut_buffer : entity is "true";
end bd_947f_0_lut_buffer_0_lut_buffer_v2_0_0_lut_buffer;

architecture STRUCTURE of bd_947f_0_lut_buffer_0_lut_buffer_v2_0_0_lut_buffer is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bd_947f_0_lut_buffer_0 is
  port (
    tdi_i : in STD_LOGIC;
    tms_i : in STD_LOGIC;
    tck_i : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of bd_947f_0_lut_buffer_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of bd_947f_0_lut_buffer_0 : entity is "bd_947f_0_lut_buffer_0,lut_buffer_v2_0_0_lut_buffer,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of bd_947f_0_lut_buffer_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of bd_947f_0_lut_buffer_0 : entity is "lut_buffer_v2_0_0_lut_buffer,Vivado 2019.2.1";
end bd_947f_0_lut_buffer_0;

architecture STRUCTURE of bd_947f_0_lut_buffer_0 is
...
begin
inst: entity work.bd_947f_0_lut_buffer_0_lut_buffer_v2_0_0_lut_buffer
     port map (
      bscanid_en_i => bscanid_en_i,
