...
`include "../core/spbits.sv"
  ...
  `localpar GEM_FR_W       = (N_GE11_LAY * GEM_CLS_PER_BX * GEM_CLU_BW); ///< Number of bits in the GEM data frame, 2 layers * 8 clusters * 15 bits
   ...
   wire report_gem, stress_rpc, stress_gem;
   wire [1:0] stress_prescale_code;
         ...
         begin
            ...
            begin
               ...
               begin
                  ...
                  if (stress == 1'b1 && stress_rpc == 1'b1) rpc_th_d[0][0][0][0] = 5'b00011;
...
//                      };
      ...
      begin
         ...
         // nn_d0 is 2-bit wide now, adding extra 0 in front for compatibility
         if (use_nn_pt == 1'b1) ptlut_nnpt[j] = {18'h0, nn_pt_v[j], 1'b0, nn_d0[j], nn_pt[j]};
...
//              bxn_counter[2:0],
   ...
   (
        ...
        .window               (valor_window),
        .stress               (stress),
        .stress_prescale_code (stress_prescale_code),
      ...
      begin
         ...
         case (st)
           ...
           begin
              ...
              rpc_present_r = rpc_present;
              gem_present_r = gem_present;
   ...
   assign daq_state_cnt = {1'b0, amc13_ready, tts_data, tts_ill_cnt, tts_rdy_cnt, tts_wof_cnt, tts_bsy_cnt, tts_oos_cnt};
