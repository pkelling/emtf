...
(
    ...
    csc_mpcx_u csc_i;
    assign csc_i.lcts.lct0 = lct_i.lct0;
    assign csc_i.lcts.lct1 = lct_i.lct1;

    csc_mpcx_u csc_o;
    // if alignment delay is 0, feed inputs directly to outputs
    assign lct_o.lct0 = (applied_delay == 'b0) ? lct_i.lct0 : csc_o.lcts.lct0;
    assign lct_o.lct1 = (applied_delay == 'b0) ? lct_i.lct1 : csc_o.lcts.lct1;


    reg [4:0] cnt = 'h0;
    assign alg_out_range = (cnt == 5'h1f); // counter reached terminal value = alignment out of range, or BC0 did not come
    
    wire lct_bc0 = lct_i.lct0.bc0; // BC0 coming from link, without delay
    reg lct_bc0_r;
