...
# Timestamp: 2021-02-19 12:40:06.648
# User: madorsky
...
create_clock -period 3.125 -name rxclk1_6 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[9]*mgt_loop[2]*GTHE2_CHANNEL_inst*}]]; # ge11_rx5
create_clock -period 3.125 -name rxclk1_7 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[9]*mgt_loop[3]*GTHE2_CHANNEL_inst*}]]; # ge11_rx4
create_clock -period 3.125 -name rxclk1_8 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[10]*mgt_loop[0]*GTHE2_CHANNEL_inst*}]]; # ge11_rx1
create_clock -period 3.125 -name rxclk1_9 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[10]*mgt_loop[1]*GTHE2_CHANNEL_inst*}]]; # ge11_rx0
create_clock -period 6.250 -name rxclk1_10 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[10]*mgt_loop[2]*GTHE2_CHANNEL_inst*}]]; # mpcn_rx8
create_clock -period 6.250 -name rxclk1_12 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[11]*mgt_loop[0]*GTHE2_CHANNEL_inst*}]]; # mpcn_rx4
create_clock -period 6.250 -name rxclk1_13 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[11]*mgt_loop[1]*GTHE2_CHANNEL_inst*}]]; # mpcn_rx5
create_clock -period 6.250 -name rxclk1_14 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[11]*mgt_loop[2]*GTHE2_CHANNEL_inst*}]]; # mpcn_rx0
create_clock -period 6.250 -name rxclk1_15 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[11]*mgt_loop[3]*GTHE2_CHANNEL_inst*}]]; # mpcn_rx1
create_clock -period 4.000 -name rxclk1_16 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[12]*mgt_loop[0]*GTHE2_CHANNEL_inst*}]]; # cppf_rx3
create_clock -period 4.000 -name rxclk1_17 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[12]*mgt_loop[1]*GTHE2_CHANNEL_inst*}]]; # cppf_rx4
create_clock -period 4.000 -name rxclk1_18 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[12]*mgt_loop[2]*GTHE2_CHANNEL_inst*}]]; # cppf_rx5
create_clock -period 4.000 -name rxclk1_19 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[12]*mgt_loop[3]*GTHE2_CHANNEL_inst*}]]; # cppf_rx6
create_clock -period 6.250 -name rxclk1_20 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[13]*mgt_loop[0]*GTHE2_CHANNEL_inst*}]]; # mpc4_rx5
create_clock -period 6.250 -name rxclk1_21 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[13]*mgt_loop[1]*GTHE2_CHANNEL_inst*}]]; # mpc4_rx4
create_clock -period 6.250 -name rxclk1_22 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[13]*mgt_loop[2]*GTHE2_CHANNEL_inst*}]]; # mpc4_rx1
create_clock -period 6.250 -name rxclk1_23 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[13]*mgt_loop[3]*GTHE2_CHANNEL_inst*}]]; # mpc4_rx0
create_clock -period 6.250 -name rxclk1_24 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[14]*mgt_loop[0]*GTHE2_CHANNEL_inst*}]]; # mpc3_rx5
create_clock -period 6.250 -name rxclk1_25 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[14]*mgt_loop[1]*GTHE2_CHANNEL_inst*}]]; # mpc3_rx4
create_clock -period 6.250 -name rxclk1_26 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[14]*mgt_loop[2]*GTHE2_CHANNEL_inst*}]]; # mpc3_rx1
create_clock -period 6.250 -name rxclk1_27 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[14]*mgt_loop[3]*GTHE2_CHANNEL_inst*}]]; # mpc3_rx0
create_clock -period 6.250 -name rxclk1_28 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[15]*mgt_loop[0]*GTHE2_CHANNEL_inst*}]]; # mpc2_rx5
create_clock -period 6.250 -name rxclk1_29 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[15]*mgt_loop[1]*GTHE2_CHANNEL_inst*}]]; # mpc2_rx4
create_clock -period 6.250 -name rxclk1_30 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[15]*mgt_loop[2]*GTHE2_CHANNEL_inst*}]]; # mpc2_rx1
create_clock -period 6.250 -name rxclk1_31 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[15]*mgt_loop[3]*GTHE2_CHANNEL_inst*}]]; # mpc2_rx0
create_clock -period 6.250 -name rxclk1_32 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[16]*mgt_loop[0]*GTHE2_CHANNEL_inst*}]]; # mpc1_rx5
create_clock -period 6.250 -name rxclk1_33 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[16]*mgt_loop[1]*GTHE2_CHANNEL_inst*}]]; # mpc1_rx4
create_clock -period 6.250 -name rxclk1_34 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[16]*mgt_loop[2]*GTHE2_CHANNEL_inst*}]]; # mpc1_rx1
create_clock -period 6.250 -name rxclk1_35 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[16]*mgt_loop[3]*GTHE2_CHANNEL_inst*}]]; # mpc1_rx0
create_clock -period 6.250 -name rxclk1_36 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[17]*mgt_loop[0]*GTHE2_CHANNEL_inst*}]]; # mpc0_rx5
create_clock -period 6.250 -name rxclk1_37 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[17]*mgt_loop[1]*GTHE2_CHANNEL_inst*}]]; # mpc0_rx1
create_clock -period 6.250 -name rxclk1_38 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[17]*mgt_loop[2]*GTHE2_CHANNEL_inst*}]]; # mpc0_rx4
create_clock -period 6.250 -name rxclk1_39 [get_pins -filter {REF_PIN_NAME=~*RXOUTCLK} -of_objects [get_cells -hierarchical -filter {NAME =~ *quad_loop[17]*mgt_loop[3]*GTHE2_CHANNEL_inst*}]]; # mpc0_rx0
