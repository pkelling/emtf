...
module mtf7_daq_tf;
  ...
  `localpar GEM_CLS_PER_BX = 8;   ///< 8 clusters per BX in GEM transmitted frame
   ...
   reg [7:0]       nn_pt [2:0] = '{8'h33, 8'h22, 8'h11}; // pt generated by NN
...
//                $write ("GEM data: %h mewc: %04d n: %04d\n", daq_data, uut.mewc, n);
                ...
                if (daq_valid)
                $write ("daq_val: %b vp: %b tbin: %h bc0: %b bxn: %h link: %h cln: %h cls: %h, prt: %h str: %02h link_id: %02h %02h %02h %02h %02h %02h %02h %02h \n",
                   daq_valid,
                   daq_gem_vp,
                   daq_gem_tbin,
                   ...
                   daq_gem_clu_par,
                   daq_gem_clu_pad,
                   uut.gem_link_id_flag[7],
                   uut.gem_link_id_flag[6],
                   uut.gem_link_id_flag[5],
                   uut.gem_link_id_flag[4],
                   uut.gem_link_id_flag[3],
                   uut.gem_link_id_flag[2],
                   uut.gem_link_id_flag[1],
                   uut.gem_link_id_flag[0],
                );
            end
    end
